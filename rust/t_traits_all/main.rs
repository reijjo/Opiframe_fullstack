...
fn attack_with_bow<T: FightFromDistance+Debug>(character: &T, opponent: &mut Monster, distance: i32) {
	if distance < 10 {
		opponent.health -= 10;
		println!("You attack with your bow. Your opponent has {} health. You are {:?}.", opponent.health, character);
	}
}

fn attack_with_sword<T: FightClose+Debug>(character: &T, opponent: &mut Monster) {
	opponent.health -= 10;
	println!("You attack with your sword. Your opponent has {} health. You are {:?}.", opponent.health, character);
}
