fn main() {
	...
	let debug_print = ();
	println!("This will now print with normal braces: {:?}", debug_print);
	...
	println!("{city1} is in {country} and {city2} is in {country}, but {city3} is not in {country}.", city1="Helsinki", city2="Turku", city3="Stockholm", country="Finland");
}